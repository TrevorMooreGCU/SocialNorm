...
<div class="accordian">
  <ul>
    ...
    <li>
	    ...
	    <a href="#">
	     	<img class="img-fluid" src="<c:url value="/resources/images/${recent.category}.jpg" />">
		</a>
    </li>
    </c:forEach>
  </ul>
				...
				<li>
					...
					<div
						...
						<div class="bg-primary text-light py-1 m-0">
							<h5 class="px-2 my-auto" style="background-color: black; padding: 10px; color: #fff !important; text-decoration: none;">${recent.title}</h5>
						</div>
						<div class="row">
