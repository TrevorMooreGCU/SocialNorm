...
<style>
.banner-section{background-image:url("${pageContext.request.contextPath}/resources/images/SocialMediaBackground.jpg"); background-size:cover; height: 380px; left: 0; position: absolute; top: 0; background-position:0;}
</style>
...
<h4 style="color: #000000;  paddding-bottom: 0px !important; margin-bottom: 0px !important">Thanks for signing up ${register.username}, feel free to login and get connected.</h4>
				...
				<li>
					...
					<div
						...
						<div class="bg-primary text-light py-1 m-0">
							<h5 class="px-2 my-auto" style="background-color: black; padding: 10px; color: #fff !important; text-decoration: none;"><a href="#" style="color: #fff !important; text-decoration: none;">${recent.title}</a></h5>
						</div>
						<div class="row">
