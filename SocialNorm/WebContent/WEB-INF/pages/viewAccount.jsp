...
<style>
.banner-section{background-image:url("${pageContext.request.contextPath}/resources/images/user.jpg"); background-size:cover; height: 380px; left: 0; position: absolute; top: 0; background-position:0;}
</style>
...
<section class="post-content-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 post-title-block">
               <div style="background-color:rgba(0, 0, 0, 0.5);">
                <h1 style="text-align: center; font-size: 60px; font-weight: bold;">${user.username}'s Account</h1>
    	...
    	<div class="col-lg-3  col-md-3 col-sm-12">
	    	<div class="well">
	            <h2 style="color: #000000">Start a Conversation!</h2>
	            <p style="color: #000000">${user.username} has been busy commenting on all the posts below. Feel free to direct message ${user.username} to have a private convo!</p>
	            <a href="<c:url value="/create/message?id=${user.id}" />" class="btn btn-default" style="color: #000000">Message</a>
	       	</div>
        </div>
  </div><!-- /row -->
  </div><!-- /container -->
